...
class ComprasSearch extends Compras
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'compra_fecha_confirmacion' => $this->compra_fecha_confirmacion,
            'compra_fecha_cierre' => $this->compra_fecha_cierre,
            'compra_fecha_anulacion' => $this->compra_fecha_anulacion,
