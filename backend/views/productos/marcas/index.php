            ...
            [
                ...
                'value'=> function($data) {
                    ...
                    $strOpciones = 
                        ...
                        Html::a(Icon::show('eye'), ['view', 'marca_id' => $data->marca_id], ['class' => 'btn btn-sm btn-azul', 'title'=>'Ver Detalles']).
                        Html::a(Icon::show('pencil-alt'), ['update', 'marca_id' => $data->marca_id], ['class' => 'btn btn-sm btn-azul', 'title'=>'Editar']).
                        Html::a(Icon::show('trash'), ['delete', 'marca_id' => $data->marca_id], [
