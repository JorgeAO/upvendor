            ...
            [
                ...
                'value'=> function($data) {
                    ...
                    $strOpciones = 
                        ...
                        Html::a(Icon::show('eye'), ['view', 'impuesto_id' => $data->impuesto_id], ['class' => 'btn btn-sm btn-azul', 'title'=>'Ver Detalles']).
                        Html::a(Icon::show('pencil-alt'), ['update', 'impuesto_id' => $data->impuesto_id], ['class' => 'btn btn-sm btn-azul', 'title'=>'Editar']).
                        Html::a(Icon::show('trash'), ['delete', 'impuesto_id' => $data->impuesto_id], [
