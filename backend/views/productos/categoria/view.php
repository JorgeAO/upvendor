...
$this->title = $model->categoria_id.' - '.$model->categoria_descripcion;
...
<div class="categoria-view">
    ...
    <p>
        ...
        <?= Html::a(Icon::show("pencil-alt").' Editar', ['update', 'categoria_id' => $model->categoria_id], ['class' => 'btn btn-sm btn-azul']) ?>
        <?= Html::a(Icon::show("trash").' Eliminar', ['delete', 'categoria_id' => $model->categoria_id], [
